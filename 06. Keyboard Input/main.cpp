    ...
    switch(msg)
    {
        case WM_KEYDOWN:
        {
            if(wparam == VK_ESCAPE)
                ...
                global_keyIsDown[GameActionMoveUp] = true;
            else if(wparam == 'A')
                global_keyIsDown[GameActionMoveLeft] = true;
            else if(wparam == 'S')
                global_keyIsDown[GameActionMoveDown] = true;
            else if(wparam == 'D')
                global_keyIsDown[GameActionMoveRight] = true;
        ...
        {
            if(wparam == 'W')
                global_keyIsDown[GameActionMoveUp] = false;
            else if(wparam == 'A')
                global_keyIsDown[GameActionMoveLeft] = false;
            else if(wparam == 'S')
                global_keyIsDown[GameActionMoveDown] = false;
            else if(wparam == 'D')
                global_keyIsDown[GameActionMoveRight] = false;
            else if(wparam == VK_UP)
                global_keyIsDown[GameActionMoveUp] = false;
            else if(wparam == VK_LEFT)
                global_keyIsDown[GameActionMoveLeft] = false;
...
// Create Pixel Shader
    ...
    while(isRunning)
    {
        ...
        if(!global_isPaused)
        {
            ...
            if(global_keyIsDown[GameActionMoveUp])
                playerPos.y += playerMoveAmount;
            if(global_keyIsDown[GameActionMoveDown])
                playerPos.y -= playerMoveAmount;
            if(global_keyIsDown[GameActionMoveLeft])
                playerPos.x -= playerMoveAmount;
            if(global_keyIsDown[GameActionMoveRight])
                playerPos.x += playerMoveAmount;
            ...
            playerColor.x = 0.5f * (sinf(colorCycleFreq * currentTimeInSeconds) + 1);
